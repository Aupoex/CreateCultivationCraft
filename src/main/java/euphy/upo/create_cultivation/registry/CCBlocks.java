...
public class CCBlocks {
    ...
    private static final CreateRegistrate REGISTRATE = CreateCultivationCraft.registrate();
    ...
    public static final BlockEntry<CultivationTankBlock> CULTIVATION_TANK = REGISTRATE.block("cultivation_tank", CultivationTankBlock::new)
            ...
            .blockstate((ctx, prov) -> prov.simpleBlock(ctx.getEntry(), prov.models().getExistingFile(prov.modLoc("block/cultivation_tank_single"))))
            .item()
            .model((ctx, prov) -> prov.withExistingParent(ctx.getName(), prov.modLoc("item/cultivation_tank_alt")))
            .tab(CCCreativeModeTabs.MAIN_TAB.getKey())
            .build()
            .register();
